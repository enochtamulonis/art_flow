...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { name: @painting.name, price: @painting.price, size: @painting.size, user_id: @painting.user_id } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { name: @painting.name, price: @painting.price, size: @painting.size, user_id: @painting.user_id } }
